...
// Toggled *MAX* values since I don't actually have endstops installed for that position
...
#define Z_SAFE_HOMING_X_POINT ((X_MIN_POS + X_MAX_POS) / 3)    // X point for Z homing when homing all axis (G28).
